...
#define FN_MAXVOLUME	2	/* maximum number of volumes */
...
#define F_MAXFILES  3     /* maximum number of files */
...
#define FATCACHE_READAHEAD 2	/* max. 256 depending on F_MAX_SECTOR_SIZE */
#endif

#if F_LONGFILENAME
#ifdef DIRCACHE_ENABLE
#define DIRCACHE_SIZE 2	/* max. 32 (<=max. cluster size) */
#endif
#endif
